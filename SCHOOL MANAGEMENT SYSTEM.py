...
if command == 'S' or command == 's' :
    ...
    if command == 'R' or command == 'r' :
        ...
        if command ==  'S' or command == 's' :
            ...
            def generate_report_card_periodic( edit_dict , edit_list , roll_no , class_teacher , class_sec ) :
            ...
            for y in dbconn :
                ...
                generate_report_card_periodic( edit_dict , edit_list , roll_no , class_teacher , class_sec )
